...
const actions = {
  async getStatus({ commit }) {
    const status = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/status`
    );
  ...
  async getP2PInfo({ commit }) {
    const p2pInfo = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/system/ethereum-p2p-connection-details`
    );
  ...
  async getRpcInfo({ commit }) {
    const rpcInfo = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/system/ethereum-rpc-connection-details`
    );
  ...
  async getSync({ commit }) {
    const sync = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/sync`
    );
  ...
  async getBlocks({ commit, state, dispatch }) {
    ...
    const latestFiveBlocks = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/blocks?from=${currentBlock - 3}&to=${currentBlock}`
    );
  ...
  async getChartData({dispatch, state, commit}) {
    ...
    const lastDaysBlocks = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/blocks?from=${currentBlock - 143}&to=${currentBlock}`
    );
  ...
  async getVersion({ commit }) {
    const version = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/version`
    );
  ...
  async getPeers({ commit }) {
    const peers = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/connections`
    );
  ...
  async getStats({ commit }) {
    const stats = await API.get(
      `${process.env.VUE_APP_API_BASE_URL}/v1/ethereumd/info/stats`
    );
