<template v-slot:modal-header="{ close }" title="Connect to ethereum Node">
  <div
    class="px-2 px-sm-3 pt-2 d-flex flex-column justify-content-between w-100 mt-n4"
  >
    <h3>Connect to ethereum Node</h3>
    <p class="text-muted mb-md-4">
        Connect any wallet that supports ethereum Core's RPC or P2P connection to your node using these details.
    </p>
    <div class="pb-2 pb-sm-3">
      <div class="row flex-column-reverse flex-lg-row">
        ...
        <div class="col-12 col-lg-8 align-items-center">
          ...
          <div v-if="chosenMode === 'rpcTor' || chosenMode === 'rpcLocal'">
            <b-row>
              <b-col cols="12" lg="6">
                <label class="mb-1 d-block"
                  ><small class="font-weight-bold"
                    >ethereum Core RPC Username</small
                  ></label
                >
                <input-copy
                  v-if="rpc.rpcuser"
              ...
              <b-col cols="12" lg="6">
                <label class="mb-1 d-block"
                  ><small class="font-weight-bold"
                    >ethereum Core RPC Password</small
                  ></label
                >
                <input-copy
              ...
              <b-col cols="12" lg="6">
                <label class="mb-1 d-block"
                  ><small class="font-weight-bold"
                    >ethereum Core RPC Address (Host)</small
                  ></label
                >
                <input-copy
                  v-if="rpc.torAddress"
          ...
          <div v-if="chosenMode === 'p2pLocal' || chosenMode === 'p2pTor'">
            <label class="mb-1 d-block"
              ><small class="font-weight-bold"
                >ethereum Core P2P Address (Host)</small
              ></label
            >
      ...
      <p class="mt-2">
        Looking for step-by-step instructions to connect your wallet to your ethereum node? <a href="https://link.umbrel.com/connect-ethereum" target="_blank">Click here</a>.
    </p>
    </div>
  </div>
</template>
