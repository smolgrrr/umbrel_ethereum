    ...
    >
      ...
      <b-alert variant="warning" show class="mb-3">
        <small>
          ...
          with other apps on your Umbrel that connect to your ethereum node. Only make 
      ...
      <b-overlay :show="isSettingsDisabled" rounded="sm">
        ...
        >
          ...
          <div>
            ...
            <small class="w-sm-75 d-block text-muted mt-1">
              Broadcast your node to the ethereum network to help other nodes 
          ...
          <div>
            ...
            <small class="w-sm-75 d-block text-muted mt-1">
              ...
              speed up the initial synchronization of your ethereum node, but after 
          ...
          <div>
            ...
            <small class="w-sm-75 d-block text-muted mt-1">
              Allow any transaction in the mempool of your ethereum node to be replaced with
          ...
          <!-- <div>
            ...
            <small class="w-sm-75 d-block text-muted mt-1">
              Rebuild the database index used by your ethereum node. This can 
          ...
          <small class="w-sm-75 d-block text-muted mt-1">
            Choose which network you want your ethereum node to connect to. 
            If you change the network, restart your Umbrel to make sure any 
            apps connected to your ethereum node continue to work properly.
          </small>
        </div>
        ...
        <b-row>
          ...
          <b-col cols="12" lg="6">
            <b-button class="mt-2 mt-lg-0" variant="success" type="submit" block :disabled="isSettingsDisabled">
              Save and Restart ethereum Node</b-button
            >
          </b-col>
        </b-row>
      </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ethereumConfig: state => state.user.ethereumConfig,
  ...
  methods: {
    ...
    setSettings() {
      // deep clone ethereumConfig in order to properly reset state if user hides modal instead of clicking the save and restart button
      this.settings = cloneDeep(this.ethereumConfig);
    },
