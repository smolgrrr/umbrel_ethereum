...
async function getethereumdAddresses() {
  ...
  const networkInfo = (await ethereumdService.getNetworkInfo()).result;
...
function getMostValidatedIP(peerInfo) {
  ...
  for (const peer of peerInfo) {
    ...
    if (Object.prototype.hasOwnProperty.call(peer, 'addrlocal')) {
      ...
      // Ignore localhost, this is incorrect data from ethereumd
